namespace Nintemulator.GB.SPU
{
    ...
    public partial class Spu : Gameboy.Processor
    {
        ...
        public Spu(Gameboy gameboy, Timing.System system)
            : base(gameboy, system)
        {
            Single = system.Apu;
            ...
            sq1 = new ChannelSq1(gameboy, system);
            sq2 = new ChannelSq2(gameboy, system);
            noi = new ChannelNoi(gameboy, system);
            wav = new ChannelWav(gameboy, system);
            reg = new byte[3];
        }
